...
const Hero = () => {
    ...
    return ( 
        ...
        className=" mt-44 md:px-14 lg:px-20 px-5 flex flex-col lg:flex-row lg:items-start items-center">
            <div>
                ...
                <div className="mt-10 lg:mt-32 flex flex-row items-center space-x-7">
                    <button className=" text-sm rounded-lg text-[#fff] border border-black bg-black hover:bg-transparent py-4 px-5 font-IBM hover:text-[#000] transition-all duration-300">Get In Touch</button>
                    <button className=" text-sm text-black border rounded-lg border-black py-4 px-5 font-IBM hover:border-0 hover:text-[#fff] hover:bg-black transition-all duration-300">Resume</button>
                </div>
            </div>
            <div className=" mt-20 lg:-mt-0">
                ...
                <motion.div 
                initial={{rotateY:180}}
                animate={{translateY:'-350px', translateX:'40px', rotateY:0}}
            ...
            <div className=" flex flex-row space-x-5 fixed md:right-24 md:bottom-10 bottom-5 right-5">
                ...
                <span className="flex space-x-1 items-end">
                    ...
                    <p className=" font-IBM text-xs">TW</p>
                </span>
            </div>
